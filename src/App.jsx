...
export default function App() {
  // DEMO STATE: this simulates the authorization engine output.
  // Later, we’ll replace this with real signals.
  const [authState, setAuthState] = useState("blocked"); // "blocked" | "authorized" | "review"
        ...
        <div className="hero-inner">
          <div className="hero-copy">
            ...
            <div className="cta-row">
              <a className={stateConfig.ctaClass} href="#">
                {stateConfig.ctaText}
              </a>
